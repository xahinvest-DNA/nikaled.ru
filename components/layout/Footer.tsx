    ...
    <footer className="border-t border-steel/10 bg-white">
      <div className="container-narrow grid gap-8 py-10 md:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-3 max-w-md text-sm text-steel/80">
            Вывески, объёмные буквы, лайтбоксы, отделка фасадов и согласование в Воронеже. Берём на себя замер, дизайн,
            производство, монтаж и документы.
          </p>
          <a
      ...
      <div className="border-t border-steel/10 py-4">
        <div className="container-narrow text-xs text-steel/65">
          Работаем по Воронежу и Воронежской области. Делаем наружную рекламу, входные группы и фасадные решения под открытие,
          ребрендинг и согласование.
        </div>
      </div>
    </footer>
  );
