    ...
    <footer className="border-t border-steel/10 bg-white">
      <div className="container-narrow grid gap-8 py-10 md:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-3 max-w-md text-sm text-steel/80">
            Делаем вывески, объёмные буквы, лайтбоксы и помогаем с фасадами в Воронеже. Можно обратиться к нам за расчётом,
            изготовлением, монтажом и согласованием.
          </p>
          <a
      ...
      <div className="border-t border-steel/10 py-4">
        <div className="container-narrow text-xs text-steel/65">
          Работаем по Воронежу и Воронежской области. Делаем вывески, входные группы и фасадные работы для магазинов, салонов,
          кафе, офисов и других небольших объектов.
        </div>
      </div>
    </footer>
  );
