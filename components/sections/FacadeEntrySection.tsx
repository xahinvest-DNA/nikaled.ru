        ...
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-6 text-steel/80 md:text-base">
              Если одной вывески уже мало и фасад выглядит уставшим, можем обновить входную группу, фриз и отдельные части фасада.
              Это подходит для офисов, магазинов, медцентров, частных домов и небольших коммерческих зданий.
            </p>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
            ...
            <article className="rounded-2xl border border-steel/10 bg-paper px-5 py-5">
              ...
              <p className="mt-4 text-sm leading-6 text-steel/80">
                Достаточно прислать фото фасада или входной группы, примерные размеры и пару слов о задаче. Мы скажем, что можно
                сделать в вашем случае и сколько это примерно будет стоить.
              </p>
            </article>
          </div>
        </div>
