      ...
      <div className="container-narrow">
        <div className="max-w-4xl">
          ...
          <p className="mt-3 text-sm leading-6 text-steel/80 md:text-base">
            Ниже мы показываем не реализованные объекты, а честные визуальные сценарии того, как может выглядеть фасадный проект после
            обновления. Эти концепции сделаны на базе реального опыта более 7 лет в отделке фасадов и помогают быстрее обсудить
            стиль, масштаб и подход к объекту ещё до замера и расчёта.
          </p>
