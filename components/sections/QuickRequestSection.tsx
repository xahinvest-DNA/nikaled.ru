...
const checklist = [
  ...
  "Что нужно сделать: вывеска, буквы, лайтбокс или согласование",
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_320px] lg:items-center">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-steel/80">
              ...
              ориентир по бюджету и следующий шаг без длинной переписки.
            </p>
          ...
          <div className="rounded-2xl border border-steel/10 bg-paper p-5">
            ...
            <p className="mt-3 text-sm leading-6 text-steel/80">
              Вы быстро понимаете, какой формат подходит вашему объекту, сколько это примерно стоит и нужен ли выезд на замер уже сейчас.
            </p>
            <div className="mt-5">
