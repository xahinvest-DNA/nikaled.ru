...
const categoryIntro = [
  "Как выбрать подходящую вывеску.",
  "От чего зависит цена.",
  "Когда нужно заранее подумать о согласовании."
];
    ...
    <>
      ...
      <main className="container-narrow section-space pb-24 md:pb-16">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-6 text-steel/80">
          Здесь собраны статьи, которые помогают быстрее разобраться в теме до звонка или заявки. Объясняем простым языком, какую
          вывеску выбрать, от чего зависит цена и когда лучше заранее подумать о согласовании.
        </p>
