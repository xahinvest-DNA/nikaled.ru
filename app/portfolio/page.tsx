    ...
    <>
      ...
      <main className="container-narrow section-space pb-24 md:pb-16">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-steel/80">
          Здесь собраны наши работы: вывески, объёмные буквы, лайтбоксы, входные группы и фасадные решения. Показываем не только
          фото, но и рассказываем, что нужно было сделать и какой результат получился.
        </p>
