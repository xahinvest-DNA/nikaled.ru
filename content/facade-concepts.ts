...
export const facadeConcepts: FacadeConceptItem[] = [
  {
    ...
    summary:
      "Визуальный сценарий для аккуратной входной группы офиса или административного объекта: композитные панели, чистая геометрия входа, спокойная корпоративная подача.",
  ...
  },
  {
    ...
    focus: ["Частный дом", "Локальная отделка", "Спокойный современный вид"]
  },
  {
    ...
    summary:
      "Коммерческий фасад, где отделка и фриз заранее собраны так, чтобы потом вывеска работала сильнее и точка выглядела как единый объект, а не набор случайных деталей.",
