...
export const facadeConcepts: FacadeConceptItem[] = [
  {
    ...
    summary:
      "Пример аккуратной входной группы для офиса или административного здания: композитные панели, чистые линии и спокойный внешний вид.",
  ...
  },
  {
    ...
    summary:
      "Пример для частного дома, где хочется обновить фасад без большой стройки: локальная облицовка, аккуратная входная зона и спокойные цвета.",
